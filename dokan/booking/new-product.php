            ...
            <form class="dokan-product-edit-form" role="form" method="post">
                ...
                <div class="dokan-form-top-area">
                    ...
                    <div class="content-half-part">
                        ...
                        <div class="dokan-form-group">
							<input type="hidden" value="Rental" name="prod_module">
                            ...
                            <!-- ============================= -->
                            <?php
                                $data_prod_comission = 0;
                                $get_prod_module = get_post_meta($post_id, '_prod_module', true);
                                $term = array();
                                $term = wp_get_post_terms( $post_id, 'product_cat', array( 'fields' => 'ids') );                                      
                                ?>
                                <select data-placeholder="Select product category" name="<?="multiple" == $multiple ? 'product_cat[]' : 'product_cat'?>" id="product_cat" class="product_cat dokan-form-control dokan-select2" tabindex="-1" aria-hidden="true" data-placeholder="Select product category" <?=('multiple' == $multiple) ? "multiple='multiple'" : "" ?>>
                                    <?php
                                        $first_args = array(
                                            'show_option_none' => '',
                                            'parent' => 17574, 
                                        ...
                                        if( !empty($first_subcats) ){
                                          //  echo '<option class="level-0" data-test="00" value="17574" data-commission="0" data-product-id="'.$post_id.'" selected="selected">';
                                          //  echo 'Rental';
                                          //  echo '</option>';
                                            foreach ($first_subcats as $key => $category) {
                                                echo '<option class="level-0" value="'.$category->term_id.'" data-commission="'.$data_prod_comission.'" data-product-id="'.$data_prod_id.'"'.(in_array($category->term_id, $term) ? 'selected="selected"' : '').'>';
                                                echo $category->name;
                                                echo '</option>';
                                                // START second level
                                                //===================
                                                ...
                                                if( !empty($second_subcats) ){
                                                    foreach ($second_subcats as $key => $category) {
                                                        echo '<option class="level-1" data-test="00" value="'.$category->term_id.'" data-commission="'.$data_prod_comission.'" data-product-id="'.$data_prod_id.'"'.(in_array($category->term_id, $term) ? 'selected="selected"' : '').'>';
                                                        ...
                                                        if( !empty($third_subcats) ){
                                                            foreach ($third_subcats as $key => $category) {
                                                                echo '<option class="level-2" value="'.$category->term_id.'" data-commission="'.$data_prod_comission.'" data-product-id="'.$data_prod_id.'"'.(in_array($category->term_id, $term) ? 'selected="selected"' : '').'>';
                                                                ...
                                                                if( !empty($fourth_subcats) ){
                                                                    foreach ($fourth_subcats as $key => $category) {
                                                                        echo '<option class="level-3" value="'.$category->term_id.'" data-commission="'.$data_prod_comission.'" data-product-id="'.$data_prod_id.'"'.(in_array($category->term_id, $term) ? 'selected="selected"' : '').'>';
                                                                        ...
                                                                        if( !empty($fifth_subcats) ){
                                                                            foreach ($fifth_subcats as $key => $category) {
                                                                                echo '<option class="level-4" value="'.$category->term_id.'" data-commission="'.$data_prod_comission.'" data-product-id="'.$data_prod_id.'"'.(in_array($category->term_id, $term) ? 'selected="selected"' : '').'>';
                                                                                ...
                                                                                if( !empty($sixth_subcats) ){
                                                                                    foreach ($sixth_subcats as $key => $category) {
                                                                                        echo '<option class="level-5" value="'.$category->term_id.'" data-commission="'.$data_prod_comission.'" data-product-id="'.$data_prod_id.'"'.(in_array($category->term_id, $term) ? 'selected="selected"' : '').'>';
                                                                                        ...
                                                                                        if( !empty($seventh_subcats) ){
                                                                                            foreach ($seventh_subcats as $key => $category) {
                                                                                                echo '<option class="level-6" value="'.$category->term_id.'" data-commission="'.$data_prod_comission.'" data-product-id="'.$data_prod_id.'"'.(in_array($category->term_id, $term) ? 'selected="selected"' : '').'>';
                                                                                                ...
                                                                                                if( !empty($eighth_subcats) ){
                                                                                                    foreach ($eighth_subcats as $key => $category) {
                                                                                                        echo '<option class="level-7" value="'.$category->term_id.'" data-commission="'.$data_prod_comission.'" data-product-id="'.$data_prod_id.'"'.(in_array($category->term_id, $term) ? 'selected="selected"' : '').'>';
                                                                                                        ...
                                                                                                        if( !empty($nineth_subcats) ){
                                                                                                            foreach ($nineth_subcats as $key => $category) {
                                                                                                                echo '<option class="level-8" value="'.$category->term_id.'" data-commission="'.$data_prod_comission.'" data-product-id="'.$data_prod_id.'"'.(in_array($category->term_id, $term) ? 'selected="selected"' : '').'>';
                                                                                                                ...
                                                                                                                if( !empty($tenth_subcats) ){
                                                                                                                    echo '<option class="level-9" value="'.$category->term_id.'" data-commission="'.$data_prod_comission.'" data-product-id="'.$data_prod_id.'"'.(in_array($category->term_id, $term) ? 'selected="selected"' : '').'>';
