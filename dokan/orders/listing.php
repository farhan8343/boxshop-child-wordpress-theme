        ...
        <table class="dokan-table dokan-table-striped">
            <thead>
                <tr>
                    ...
                    <th><?php esc_html_e( 'Shipping', 'dokan-lite'); ?> </th>
            ...
            <tbody>
                ...
                foreach ( $user_orders as $order ) {
                    ...
                    <tr >
                        ...
                        <td class="dokan-order-shipping-method" data-title="<?php esc_attr_e( 'Shipping', 'dokan-lite' ); ?>"> 
                            <?php 
                                foreach( $order->get_items( 'shipping' ) as $item_id => $item ){
                                    ...
                                    if (strpos($shipping_method_title, 'Swoove') !== false) {
                                        $shipping_method_title = 'Swoove';
                                    }
                                    echo $shipping_method_title;
                                } 
                            ?>
                        </td>
