    ...
    <form class="dokan-form-inline dokan-w8 dokan-product-date-filter" method="get" >
		...
		<div class="dokan-form-group">
            <?php
                ...
                wp_dropdown_categories( apply_filters( 'dokan_product_supplier_dropdown_args', [
                    ...
                    'order'            => 'ASC',
                    'title_li'         => '',
                    'class'            => 'dropship_supplier dokan-form-control chosen',
                    'exclude'          => '',
                    'selected'         => isset( $get_data['dropship_supplier'] ) ? $get_data['dropship_supplier'] : '-1',
                ] ) );
            ?>
        </div>
		<?php endif; ?>
