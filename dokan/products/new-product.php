...
<!--                         <div class="vendor-add-note add-new-prod-popup">
						...
						<?php $limits = get_user_products_limits(get_current_user_id()); $products = get_user_products_by_type(get_current_user_id());?>
						<div class="module-selector">
							...
							<div class="cards">
								<div class="row">
									<div data-value="Grocery" class="col-md-5 card-selector">
										Grocery
									</div>
									
									<div data-value="Supermarket" class="col-md-5 card-selector">
										Supermarket
									</div>
									
									<div data-value="Service" class="col-md-5 card-selector">
										Services
									</div>
                        ...
                        <form class="dokan-form-container dokan-hide" method="post">
                            ...
                            <div class="product-edit-container dokan-clearfix">
                                ...
                                <div class="content-half-part dokan-product-meta">
                                    ...
                                    <?php if ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'single' ): ?>
                                        <div class="dokan-form-group dokan-hide">
                                            <select data-placeholder="Select Module" name="prod_module" id="prod_module" class="product_cat dokan-form-control dokan-select2" tabindex="-1" aria-hidden="true">
                                    ...
                                    <?php elseif ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'multiple' ): ?>
                                        <div class="dokan-form-group cstm-prod-add dokan-hide">
                                            <select data-placeholder="Select Module" name="prod_module" id="prod_module" class="product_cat dokan-form-control dokan-select2" tabindex="-1" aria-hidden="true">
                                                <option class="level-0" value="">-- Select Module --</option>
                                                <option class="level-0" value="Supermarket">Supermarket</option>
                                                <option class="level-0" value="Service">Service</option>
									...
									?>
									 <div class="dokan-form-group">
										 ...
										 <?php
												$suppliers_selected  = dokan_posted_input( 'dropship_supplier' );
												$suppliers_args =  array(
													 ...
													 'exclude'          => '',
													 'selected'         => $suppliers_selected,
												);

												wp_dropdown_categories( $suppliers_args );
										 ?>
									</div>
									<?php endif; ?>
									 <div class="dokan-form-group">
