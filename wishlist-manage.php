			...
			<tr data-wishlist-id="<?php echo esc_attr( $wishlist->get_id() ); ?>">
				<td class="wishlist-name">
					...
					<div class="edit-template">
						<a style="font-size: 12px;" href="/edit-wishlist-template/?id=<?php echo esc_attr( $wishlist->get_id()) ?>"><i class="fa fa-edit" style="padding-right: 5px;"></i>Edit Template</a>
						 / <a style="font-size: 12px;" href="<?php echo esc_attr( $wishlist->get_url()) ?>"><i class="fa fa-eye" style="padding-right: 5px;"></i>View</a>
					</div>
				</td>
