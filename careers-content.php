...
$post_class = 'post-item hentry career';
...
<article <?php post_class($post_class) ?>>
	<?php if($time > $current_time || $time == $current_time ): echo '<div class="status open">Open</div>'; else:  echo '<div class="status closed">Closed</div>';  endif; ?>
			...
			<div class="entry-info">
				...
				<div class="entry-summary">
					...
					<div class="short-content">
						...
						boxshop_the_excerpt_max_words(35, $post, $strip_tags, '', true); 
						?>
					</div>
					<?php endif; ?>
